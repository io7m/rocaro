...
public enum RCFrameTargetDescriptionFactory
  implements RCGNodeDescriptionFactoryType<
  RCUnit, RCGFrameNodeTargetType, RCGFrameNodeTargetDescriptionType>
{
  /**
   * The frame target.
   */
  ...
  @Override
  public RCGFrameNodeTargetDescriptionType createDescription(
    final RCUnit parameters,
    final RCGNodeName name)
  {
    Objects.requireNonNull(parameters, "parameters");
    Objects.requireNonNull(name, "name");
    return new RCFrameTargetDescription(name);
  }
