...
public abstract class RCCAbstractCommand
  implements RCTCommentableType
{
    ...
    final Object o)
  {
    ...
    final RCCAbstractCommand c = (RCCAbstractCommand) o;
  ...
  public final void setComment(
    final String text)
  {
    this.comment = Objects.requireNonNull(text, "text");
  }
}
