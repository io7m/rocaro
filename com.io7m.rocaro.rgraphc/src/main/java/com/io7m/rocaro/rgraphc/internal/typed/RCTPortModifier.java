...
public final class RCTPortModifier
  extends RCTPortAbstract
  implements RCTPortTargetType, RCTPortSourceType
{
  public RCTPortModifier(
    final RCTOperationDeclaration inOwner,
    final RCTTypeDeclarationType inType,
    final RCCName inName,
    final RCTAccessSetType accessSet)
  {
    super(
      inOwner,
      inType,
