...
public final class RCCPPortConsumer
  extends RCObject
  implements BTElementHandlerType<Object, RCUDeclPortConsumer>
{
  private RCUDeclPortConsumer result;
  ...
  @Override
  public RCUDeclPortConsumer onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
