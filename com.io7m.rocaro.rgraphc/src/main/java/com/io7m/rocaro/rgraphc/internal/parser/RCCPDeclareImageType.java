...
public final class RCCPDeclareImageType
  extends RCObject
  implements BTElementHandlerType<Object, RCUDeclImageType>
{
  private RCUDeclImageType result;
  ...
  @Override
  public RCUDeclImageType onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
