...
public sealed interface RCCImageLayoutStatusType
{
  record Changed(
    RCGResourceImageLayout layoutFrom,
    RCGResourceImageLayout layoutTo)
    implements RCCImageLayoutStatusType
  {
    public Changed
    {
  ...
  record Unchanged(
    RCGResourceImageLayout layoutNow)
    implements RCCImageLayoutStatusType
  {
    public Unchanged
    {
      Objects.requireNonNull(layoutNow, "layoutNow");
    }
  }
}
