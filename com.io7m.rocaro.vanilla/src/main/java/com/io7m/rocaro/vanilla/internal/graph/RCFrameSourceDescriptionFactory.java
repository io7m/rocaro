...
public enum RCFrameSourceDescriptionFactory
  implements RCGNodeDescriptionFactoryType<
  RCUnit, RCGFrameNodeSourceType, RCGFrameNodeSourceDescriptionType>
{
  /**
   * The frame source.
   */
  ...
  @Override
  public RCGFrameNodeSourceDescriptionType createDescription(
    final RCUnit parameters,
    final RCGNodeName name)
  {
    Objects.requireNonNull(parameters, "parameters");
    Objects.requireNonNull(name, "name");
    return new RCFrameSourceDescription(name);
  }
