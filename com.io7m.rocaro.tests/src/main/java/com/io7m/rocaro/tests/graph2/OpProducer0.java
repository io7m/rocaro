  ...
  implements RCGOperationType
{
  ...
  public static RCGOperationFactoryType<Parameters, OpProducer0> factory()
  {
    return OpProducer0::new;
  }
  ...
  {
    return "[OpProducer0 %s]".formatted(this.name);
  }
