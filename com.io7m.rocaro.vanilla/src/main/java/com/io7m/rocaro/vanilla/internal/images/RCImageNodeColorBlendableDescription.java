...
import static com.io7m.rocaro.vanilla.internal.images.RCImageNodeColorBlendable.SAMPLE_PORT_NAME;

record RCImageNodeColorBlendableDescription(
  RCImageParametersBlendable parameters,
  RCGNodeName name,
  Map<RCGPortName, RCGPortType<?>> ports)
  implements RCImageNodeDescriptionType<RCImageParametersBlendable, RCImageColorBlendableType>
{
  RCImageNodeColorBlendableDescription
  {
  ...
  @Override
  public RCGPortSourceType<RCImageColorBlendableType> mainOutput()
  {
    return (RCGPortSourceType<RCImageColorBlendableType>)
      this.ports.get(SAMPLE_PORT_NAME);
  }

  @Override
  public RCImageNodeType<RCImageParametersBlendable> createNode()
  {
