...
public record RCImageColorBlendable(
  Vector2I size,
  ...
  implements RCImageColorBlendableType
{
  ...
  public RCImageColorBlendable
  {
    ...
    RCImageFormatPreconditions.checkColorBlendablePreconditions(format);
  }
}
