...
/**
 * A constraint on blendable color images.
 *
 * @param size     The size expression
 * @param channels The channel constraint
 */

public record RCImageConstraintColorBlendable(
  Optional<RCImageSizeExpressionType> size,
  RCImageColorChannels channels)
  implements RCImageConstraintType<RCImageColorBlendableType>
{
  private static final RCImageConstraintColorBlendable WINDOW_SIZED_RGBA =
  ...
  public RCImageConstraintColorBlendable
  {
  ...
  @Override
  public Class<RCImageColorBlendableType> dataType()
  {
    return RCImageColorBlendableType.class;
  }
      ...
      case final RCImageConstraintType<?> otherImage -> {
        yield switch (otherImage) {
          ...
          case final RCImageConstraintColorBasic _,
               ...
               final RCImageConstraintDepthStencil _,
               final RCImageConstraintColorRenderable _ -> false;
        };
      }
      default -> false;
    };
  ...
  public static RCImageConstraintColorBlendable requireBlendableWindowSizedRGBA()
  {
