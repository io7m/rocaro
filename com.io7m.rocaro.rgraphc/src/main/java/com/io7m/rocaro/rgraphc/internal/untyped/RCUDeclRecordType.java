...
public final class RCUDeclRecordType
  extends RCUGraphElement
  implements RCUTypeDeclarationType
{
  private final RCCName name;
  private final List<RCUDeclField> fields;

  public RCUDeclRecordType(
    final RCCName inName,
    final List<RCUDeclField> inFields)
  {
    this.name =
      Objects.requireNonNull(inName, "name");
    this.fields =
      List.copyOf(inFields);
  }

  public List<RCUDeclField> fields()
  {
    return this.fields;
  }
