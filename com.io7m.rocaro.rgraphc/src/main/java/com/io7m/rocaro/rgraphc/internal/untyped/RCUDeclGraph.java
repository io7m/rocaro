...
public final class RCUDeclGraph
{
  private final ArrayList<RCUGraphElementType> elements;
  private final RCCPackageName packageName;
  private final List<RCUGraphElementType> elementsRead;
  ...
  public List<RCUGraphElementType> elements()
  {
    return this.elementsRead;
  }

  public void addElement(
    final RCUGraphElementType element)
  {
    this.elements.add(
