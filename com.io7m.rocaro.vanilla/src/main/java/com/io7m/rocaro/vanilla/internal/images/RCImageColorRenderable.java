...
public record RCImageColorRenderable(
  Vector2I size,
  VulkanImageType data,
  VulkanImageViewType view,
  VulkanFormat format)
  implements RCImageColorRenderableType
{
  /**
   * A renderable color image.
   *
  ...
  public RCImageColorRenderable
  {
    ...
    RCImageFormatPreconditions.checkColorRenderablePreconditions(format);
  }
}
