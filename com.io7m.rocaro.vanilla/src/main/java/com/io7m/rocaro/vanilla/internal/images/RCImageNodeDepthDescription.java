...
record RCImageNodeDepthDescription(
  RCImageParametersDepth parameters,
  RCGNodeName name,
  Map<RCGPortName, RCGPortType<?>> ports)
  implements RCImageNodeDescriptionType<RCImageParametersDepth, RCImageDepthType>
{
  RCImageNodeDepthDescription
  {
  ...
  @Override
  public RCGPortSourceType<RCImageDepthType> mainOutput()
  {
    return (RCGPortSourceType<RCImageDepthType>)
      this.ports.get(SAMPLE_PORT_NAME);
  }

  @Override
  public RCImageNodeType<RCImageParametersDepth> createNode()
  {
