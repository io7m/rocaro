...
public final class RCCPDeclareBufferType
  extends RCObject
  implements BTElementHandlerType<Object, RCUDeclBufferType>
{
  private RCUDeclBufferType result;
  ...
  @Override
  public RCUDeclBufferType onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
