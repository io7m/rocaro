...
public final class RCCPOperation
  extends RCObject
  implements BTElementHandlerType<Object, RCUDeclOperation>
{
  private RCUDeclOperation result;
    ...
    final BTElementParsingContextType context)
  {
    return Map.ofEntries(
      ...
      Map.entry(
        element("PortConsumer"),
        RCCPPortConsumer::new
      ),
      Map.entry(
        element("PortProducer"),
        RCCPPortProducer::new
      ),
      Map.entry(
        element("PortModifier"),
        RCCPPortModifier::new
      )
    );
  }
    ...
    final Object result)
  {
    switch (result) {
      ...
      case final RCUDeclPortType p -> {
        this.result.addPort(p);
      }
      default -> {
  ...
  {
    this.result =
      new RCUDeclOperation(
        RCDeviceQueueCategory.valueOf(
          attributes.getValue("QueueCategory")
        ),
        new RCCName(
  ...
  @Override
  public RCUDeclOperation onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
