...
public final class RCCPColorAttachment
  extends RCObject
  implements BTElementHandlerType<Object, RCUDeclColorAttachment>
{
  private RCUDeclColorAttachment result;
  ...
  @Override
  public RCUDeclColorAttachment onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
