...
public record RCGPortPrimitiveModifier(
  RCGPortModifierType<?> originalPort,
  RCGResourceSubname subName,
  RCSchematicConstraintPrimitiveType<?> typeConsumed,
  RCSchematicConstraintPrimitiveType<?> typeProduced)
  implements RCGPortPrimitiveType
{
  public RCGPortPrimitiveModifier
  {
    Objects.requireNonNull(originalPort, "owner");
    Objects.requireNonNull(subName, "subName");
