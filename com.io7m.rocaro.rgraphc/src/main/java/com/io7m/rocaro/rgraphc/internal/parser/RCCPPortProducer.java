...
public final class RCCPPortProducer
  extends RCObject
  implements BTElementHandlerType<Object, RCUDeclPortProducer>
{
  private RCUDeclPortProducer result;
  ...
  @Override
  public RCUDeclPortProducer onElementFinished(
    final BTElementParsingContextType context)
  {
    return this.result;
  }
