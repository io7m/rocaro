...
import static com.io7m.rocaro.vanilla.internal.images.RCImageNodeDepth.SAMPLE_PORT_NAME;

record RCImageNodeDepthStencilDescription(
  RCImageParametersDepthStencil parameters,
  RCGNodeName name,
  Map<RCGPortName, RCGPortType<?>> ports)
  implements RCImageNodeDescriptionType<RCImageParametersDepthStencil, RCImageDepthStencilType>
{
  RCImageNodeDepthStencilDescription
  {
  ...
  @Override
  public RCGPortSourceType<RCImageDepthStencilType> mainOutput()
  {
    return (RCGPortSourceType<RCImageDepthStencilType>)
      this.ports.get(SAMPLE_PORT_NAME);
  }

  @Override
  public RCImageNodeType<RCImageParametersDepthStencil> createNode()
  {
