...
/**
 * The subset of depth formats that have stencil components.
 */

public enum RCImageDepthStencilFormat
  implements RCImageDepthFormatType
{
  /**
  ...
  DEPTH_24_UNSIGNED_NORMALIZED_8_STENCIL {
    @Override
