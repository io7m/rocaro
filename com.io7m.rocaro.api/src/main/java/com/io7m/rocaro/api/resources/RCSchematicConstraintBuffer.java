...
/**
 * Constraints involving buffers.
 *
 * @param <R> The buffer type
 * @param <S> The buffer schematic type
 */

public non-sealed class RCSchematicConstraintBuffer<
  R extends RCBufferType,
  S extends RCResourceSchematicBufferType>
  ...
  implements RCSchematicConstraintPrimitiveType<S>
{
  ...
  public RCSchematicConstraintBuffer(
