...
public interface RCResourceSchematicDepthImage2DType
  extends RCResourceSchematicImage2DType
{
  /**
   * @return The depth components in the image
   */

  RCDepthComponents depthComponents();
}
