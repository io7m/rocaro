...
public final class RCFrameSourceDescription
  extends RCObject
  implements RCGFrameNodeSourceDescriptionType
{
  ...
  public RCFrameSourceDescription(
  ...
  {
    return Map.of(this.imageSource.name(), this.imageSource);
  }
  ...
  @Override
  public RCGFrameNodeSourceType createNode()
  {
    return new RCFrameSource(
      this.name,
      this.ports(),
      this.imageSource
    );
  ...
  @Override
  public RCGPortProducer<RCImageColorBlendableType> imageSource()
  {
